...
export default function ProductDetail({ image, title, description, specs }: ProductDetailProps) {
                ...
                <ul className="space-y-2">
                  {leftSpecs.map((spec) => (
                    <li key={spec.label} className="flex items-baseline gap-1 font-outfit text-[14px] md:text-[15px]">
                      <span className="text-[#555] before:content-['•'] before:mr-2">{spec.label}:</span>
